    ...
    return (
      <div className="px-[var(--gutter-lg)] pt-2" role="alert">
        <div className="rounded-[var(--radius-card)] bg-white p-[var(--pad-card)]">
          ...
          <h2 className="mt-3 text-[15px] font-semibold text-[#1c1a16]">
          ...
          <div className="mt-4 flex items-center gap-2">
            <button
              type="button"
              onClick={this.retry}
              className="card-press rounded-full px-3.5 py-2 text-[12.5px] font-semibold text-white"
            ...
            <a
              href="#/"
              className="card-press rounded-full bg-[#f2f1ed] px-3.5 py-2 text-[12.5px] font-semibold text-[#3d3a34]"
            >
              Command centre
            </a>
          </div>
          <p className="mt-3 font-mono text-[10.5px] break-words" style={{ color: FAINT }}>
            {error.message}
          </p>
        </div>
      </div>
